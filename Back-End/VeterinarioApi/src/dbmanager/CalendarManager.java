...
public class CalendarManager {
	...
	public static CalendarManager getCalendarManager (String fileName) throws InstantiationException, IllegalAccessException, JsonParseException, JsonMappingException, IOException {
		if (calendar==null) {
			calendar = new CalendarManager(fileName);
		}
		return calendar;
	}
	public CalendarManager(String fileName) throws InstantiationException, IllegalAccessException, JsonParseException, JsonMappingException, IOException {
		if (fileName != null) {
